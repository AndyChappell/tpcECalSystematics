...
//********************************************************************
    ...
    AddStep(StepBase::kAction, "DS Position Action", new FindTracksDsPosAction());
    AddStep(StepBase::kAction, "DS Direction Action", new FindTracksDsPosDirAction());
    AddStep(StepBase::kAction, "Barrel Position Action", new FindTracksBarrelPosAction());
    AddStep(StepBase::kAction, "Barrel Direction Action", new FindTracksBarrelPosDirAction());
    AddStep(StepBase::kAction, "Choose the track Action", new ChooseTrackAction());
...
//*********************************************************************
bool tpcECalSelection::IsRelevantTrackForSystematic(const AnaEventB& event, AnaTrackB* track, Int_t syst_index, Int_t branch) const{
//*********************************************************************
...
//*********************************************************************
bool tpcECalSelection::IsRelevantTrueTrackForSystematic(const AnaEventB& event, AnaTrueTrackB* trueTrack, Int_t syst_index, Int_t branch) const{
//*********************************************************************
...
//*********************************************************************
bool tpcECalSelection::IsRelevantSystematic(const AnaEventB& event, const ToyBoxB& box, Int_t syst_index, Int_t branch) const{
//*********************************************************************
...
//*********************************************************************
bool tpcECalSelection::CheckRedoSelection(const AnaEventB& event, const ToyBoxB& PreviousToyBox, Int_t& redoFromStep){
//*********************************************************************
...
//********************************************************************
  ...
  for (unsigned int i = 0; i < tpcTracks.size(); i++) {
    ...
    if (endpos.X() != endpos.X())
      continue;
    if (!(endpos.X() > barrelLeft || endpos.X() < barrelRight || endpos.Y() < barrelBottom || endpos.Y() > barrelTop))
      continue;
...
//********************************************************************
  ...
  for (unsigned int i = 0; i < tpcTracks.size(); i++) {
    ...
    double tpcBackAzimuth = TMath::RadToDeg() * TMath::ATan(enddir.X() / enddir.Y());
...
//********************************************************************
  ...
  for (int i = 0; i < Ntpc; i++) {
    AnaTpcTrack* backTpc = static_cast<AnaTpcTrack*> (anaUtils::GetTPCBackSegment(tracks[i]));
    if (backTpc->NHits > 19) {
      pass = true;
      break;
    }
